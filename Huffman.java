...
public class Huffman {
	//C:\Users\dell\Desktop\Standard\\data.txt
	//C:\Users\dell\Desktop\Standard\\compress.txt
	...
	private void initialize() {
		...
		btnCompress.addActionListener(new ActionListener() {
			...
			sort(pcg,0);
			int level=pcg.size()-2;  //to know how many levels require
			for(int i=1,y=0;i<=level;i++,y=y+2)  //to get 1st&2nd smallest and sum 
			{
				Node n=new Node();
		...
		lblHuffmanAlgrothim.setForeground(Color.BLUE);
